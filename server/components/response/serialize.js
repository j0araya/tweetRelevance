...
module.exports = function (app, defaults) {
    defaults.logger.info('Register jsonapi serializer')
    app.remotes().after('**', function (ctx, next) {
        ...
        defaults.logger.info('Response will be serialized')
        defaults.logger.info('Set response Content-Type to `application/vnd.api+json`')
        ctx.res.set({
        ...
        /*   defaults.logger.info('===================')
           defaults.logger.info('Serialization input')
           defaults.logger.info('===================')
           defaults.logger.info('JSONAPI TYPE      |:', type)
           defaults.logger.info('SERIALIZER OPTS   |:', JSON.stringify(options))
           defaults.logger.info('RELATIONS DEFN    |:', JSON.stringify(relations))
           defaults.logger.info('DATA TO SERIALIZE |:', JSON.stringify(data))*/
        ...
        serializer(type, data, relations, options, function (err, results) {
            ...
            /*    defaults.logger.info('====================')
                defaults.logger.info('Serialization output')
                defaults.logger.info('====================')
                defaults.logger.info('SERIALIZED DATA    |:', JSON.stringify(results))*/
            next()
        })
    })
}
